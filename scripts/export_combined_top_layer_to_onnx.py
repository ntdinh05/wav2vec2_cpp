#!/usr/bin/env python3
"""Export the Combined (UXTD+TaL80) top-layer fine-tuned model to ONNX."""
...
MODEL_DIR = os.path.join(SCRIPT_DIR, "wav2vec2-combined-finetuned-top-layer")
ONNX_OUT  = os.path.join(PROJECT_DIR, "onnx_models", "wav2vec2_combined_top_layer.onnx")
